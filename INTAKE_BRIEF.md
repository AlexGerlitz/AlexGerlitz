...
- required handoff depth: docs only, tests, deployment, monitoring, operator guide, or support.

## For A Technical Review

Send:

- repository or system link;
- what is failing or unclear;
- logs, screenshots, or error text if safe to share;
- what changed recently;
- what must not be broken;
- how you currently verify success.

I will usually respond with:
...
- logs, health checks, smoke checks, runbooks, and handoff docs.
