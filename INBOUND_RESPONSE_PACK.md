...
- systems, tools, documents, transcripts, APIs, or CRM objects involved;
...
- deployment, release, health-check, backup, logging, and recovery paths;
- fixed-scope automation builds with clear success criteria.
...
- Fixed-scope offers: https://alexgerlitz.github.io/AlexGerlitz/fixed-scope-offers.html
