...
- Latest recorded recruiter-funnel content snapshot is green on `4672074`; the July 1 packaging adds LinkedIn About replacement copy, keeps the proof routes smoke-visible, removes direct geography-specific long-term targeting from public copy, and refreshes LinkedIn Proof Signal, Recruiter Preferences, and this Verification Pack to the live headline, current live Open-to-Work boundary, recommended first-job title set, CI/CD-first Skills surface, current Featured order, live About replacement, and source-backed activation plan.
