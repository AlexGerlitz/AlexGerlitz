...
- CRM/ERP/1C/banking/accounting/API/database integration with contracts, retries, logs, rollout
...
Send one concrete workflow or service request with:

- the business process and current tools;
...
- Proof route: repo, CI run, live route, doc, demo, or PDF resume path that supports the decision.
