...
- AI Ops public proof status tracks live-runtime reachability, 52-pass local public gate, reviewer observability snapshot, committed runtime evidence, LLM provider fallback state, and transcription provider state without exposing secrets: https://github.com/AlexGerlitz/ai-ops-workflow-kit/blob/main/docs/PUBLIC_PROOF_STATUS.md
