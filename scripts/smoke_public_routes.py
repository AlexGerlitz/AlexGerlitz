...
ROUTES: tuple[RouteCheck, ...] = (
    ...
    RouteCheck(
        ...
        (
            ...
            "Enterprise Readiness",
            "international remote-team review route for architecture, state ownership, integration contracts, reliability, privacy, observability, CI, runbooks, and handoff quality",
