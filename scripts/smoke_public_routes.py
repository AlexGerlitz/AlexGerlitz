...
ROUTES: tuple[RouteCheck, ...] = (
    ...
    RouteCheck(
        ...
        (
            ...
            "Shortest inbound path",
            "First useful result",
            "Copy this recruiter message: Hi Alex, I am hiring for a remote backend/platform or AI automation role.",
            ...
            "before Hiring Decision, Recruiter Preferences, Role Targets, Skill Evidence, and the PDF resume",
    ...
    RouteCheck(
        ...
        (
            "# LinkedIn Proof Signal",
            "Use this as the short public update route for a LinkedIn profile view",
            "The live Featured route now starts with LinkedIn Proof Signal, then First Backend Role Screen, Backend First Screen, Autoschool Intake/Admin Proof, DriveDesk AI Operator proof route, Fixed-Scope AI Automation Offers, and DriveDesk Core.",
