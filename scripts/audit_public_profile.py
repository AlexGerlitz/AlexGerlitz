...
REQUIRED_TEXT = {
    ...
    "START_HERE.md": [
        ...
        "DeployMate proof",
        "Enterprise Readiness",
        "international employer-grade review of architecture, state, integration contracts, English-first docs, international role screen, specialist backend-owned AI workflow signal, reliability, privacy, CI, runbooks, contact context, and handoff quality",
        "Fast Decision Route",
        "30 seconds",
        "60 seconds",
        "Project request",
