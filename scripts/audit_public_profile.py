...
REQUIRED_TEXT = {
    ...
    "llms.txt": [
        ...
        "Recruiter Preferences",
        "Open-to-Work alignment for job titles, remote work mode, employment types, recruiter search keywords, recruiter filter map, proof stack by search intent, proof order, and first contact fit.",
