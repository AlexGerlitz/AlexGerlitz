...
REQUIRED_TEXT = {
    ...
    "recruiter-preferences.html": [
        ...
        "Verified LinkedIn skill-filter state as of 2026-06-30",
        "the visible All skills view surfaces Python, REST APIs, OpenAPI Specification (OAS), GitHub, DevOps, Platform Architecture",
        "Systems Integration, Vector Databases, ERP, and CRM",
        "keep Python first while",
        "making FastAPI, GitHub Actions, and RAG more visible",
        "Python Backend Automation Engineer with internal tools, API/CRM integrations, QA Automation Python, FastAPI, PostgreSQL, and DriveDesk AI Operator.",
    ...
    "llms.txt": [
        ...
        "AI Backend Proof Pack",
        "compact route through Python/backend automation, AI workflow, integration, Docker/CI boundary, live proof, verification, Decision-Ready Contact before PDF resume, and resume evidence",
    ...
    "linkedin-proof-signal.html": [
        ...
        "The live Skills surface is verified: All view starts with Python, REST APIs, OpenAPI Specification (OAS), GitHub, DevOps, Platform Architecture, Systems Integration, Vector Databases, ERP, and CRM",
    ...
    "LINKEDIN_PROOF_SIGNAL.md": [
        ...
        "The public Featured route now starts with LinkedIn Proof Signal, then Delivery Capability, Application Fit Pack, First Backend Role Screen, Autoschool Intake/Admin Proof, DriveDesk AI Operator proof route, Fixed-Scope AI Automation Offers, and DriveDesk Core.",
        "The live Skills surface is verified instead of assumed: All view starts with Python, REST APIs, OpenAPI Specification (OAS), GitHub, DevOps, Platform Architecture, Systems Integration, Vector Databases, ERP, and CRM",
        "Verified LinkedIn Skill Surface",
...
SITEMAP_LASTMOD_REQUIREMENTS = {
    ...
    "https://alexgerlitz.github.io/AlexGerlitz/linkedin-proof-signal.html": "2026-06-30",
    "https://alexgerlitz.github.io/AlexGerlitz/LINKEDIN_PROOF_SIGNAL.md": "2026-06-30",
    "https://alexgerlitz.github.io/AlexGerlitz/recruiter-preferences.html": "2026-06-30",
    ...
    "https://alexgerlitz.github.io/AlexGerlitz/llms.txt": "2026-06-30",
    ...
    "https://alexgerlitz.github.io/AlexGerlitz/RECRUITER_PREFERENCES.md": "2026-06-30",
...
CURRENT_EVIDENCE_SNIPPETS = {
    "VERIFICATION_PACK.md": [
        ...
        "All view: Python, REST APIs, OpenAPI Specification (OAS), GitHub, DevOps, Platform Architecture, Systems Integration, Vector Databases, ERP, CRM.",
    ...
    "verification-pack.html": [
        ...
        "LinkedIn Proof Signal first, then DriveDesk AI Operator - Proof Route, Fixed-Scope AI Automation Offers, and DriveDesk Core",
        "Skills surface: All view shows Python, REST APIs, OpenAPI Specification (OAS), GitHub, DevOps, Platform Architecture, Systems Integration, Vector Databases, ERP, and CRM; Tools & Technologies shows Python, REST APIs, GitHub, Telegram, pytest, OpenAPI, SaaS, Docker, FastAPI, and PostgreSQL.",
        ...
        "https://github.com/AlexGerlitz/AlexGerlitz/actions?query=branch%3Amain+workflow%3Apages-build-deployment",
        "https://github.com/AlexGerlitz/AlexGerlitz/actions/workflows/live-profile-smoke.yml?query=branch%3Amain",
        "https://github.com/AlexGerlitz/AlexGerlitz/actions/runs/28416053131",
        "https://github.com/AlexGerlitz/AlexGerlitz/actions/runs/28416052581",
        "https://github.com/AlexGerlitz/AlexGerlitz/actions/runs/28416053122",
        ...
        "Python-first LinkedIn skills copy",
        "GitHub profile proof metadata audit runs inside Live Profile Smoke for pinned repositories",
        "drivedesk-core",
        "ai-ops-workflow-kit",
        "deploymate",
