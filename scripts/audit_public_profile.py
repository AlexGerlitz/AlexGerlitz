...
REQUIRED_TEXT = {
    ...
    "llms.txt": [
        ...
        "LinkedIn Recruiter Packet",
        "search filters, 30-second fit, proof order, message triggers, decision-ready reply, expected first result, shortlist signal, risk reduction, AI-assisted execution proof, and international remote-team proof routing",
        "Recruiter Preferences",
