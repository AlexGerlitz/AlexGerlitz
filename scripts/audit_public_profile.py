...
REQUIRED_TEXT = {
    ...
    "linkedin-recruiter-packet.html": [
        ...
        "Telegram request -> backend validation -> database record -> admin queue -> operator status update, with synthetic-only public evidence.",
        ...
        '"position": 8, "name": "Decision-Ready Contact"',
        '"position": 9, "name": "PDF Resume"',
    ...
    "LINKEDIN_RECRUITER_PACKET.md": [
        ...
        "First proof: [Decision-Ready Contact](https://alexgerlitz.github.io/AlexGerlitz/decision-ready-contact.html) -> [Autoschool Intake/Admin Proof]",
