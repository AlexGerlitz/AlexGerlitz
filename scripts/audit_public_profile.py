...
REQUIRED_TEXT = {
    ...
    "decision-ready-contact.html": [
        ...
        "Decision-ready contact route with recruiter offer triage, copy-ready first messages for remote roles",
        "Recruiter offer triage and copy-ready first messages for one role, workflow, project, or proof question",
        "Recruiter offer triage plus copy-ready first-contact route with fit read, risky assumptions, first slice, proof path, and next route.",
