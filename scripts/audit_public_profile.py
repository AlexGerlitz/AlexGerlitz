...
REQUIRED_TEXT = {
    ...
    "SKILL_EVIDENCE.md": [
        ...
        "AI Ops Workflow Kit",
        "First Slice Playbook",
        "https://github.com/AlexGerlitz/ai-ops-workflow-kit/actions/runs/28327736967",
    ],
    "skill-evidence.html": [
    ...
    "featured-drivedesk.html": [
        ...
        "The current AI Ops proof is green on commit <code>fe5deb8</code> with CI run <code>28327736967</code>, including the first slice playbook and reviewer observability snapshot.",
...
CURRENT_EVIDENCE_SNIPPETS = {
    "VERIFICATION_PACK.md": [
        ...
        "AI Ops First Slice Playbook is published",
        "https://github.com/AlexGerlitz/ai-ops-workflow-kit/blob/main/docs/FIRST_SLICE_PLAYBOOK.md",
        "AI Ops latest checked CI run succeeded on `fe5deb8`",
        "https://github.com/AlexGerlitz/ai-ops-workflow-kit/actions/runs/28327736967",
