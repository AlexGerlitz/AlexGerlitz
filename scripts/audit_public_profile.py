...
REQUIRED_TEXT = {
    ...
    "hiring-decision.html": [
        ...
        "Open first: AI Automation Role Fit -> DriveDesk Proof Route -> AI Ops Business Scenario Replay -> AI Backend Proof Pack -> Enterprise Readiness -> PDF Resume.",
    ...
    "SKILL_EVIDENCE.md": [
        ...
        "AI Ops Workflow Kit",
        "First Slice Playbook",
        "https://github.com/AlexGerlitz/ai-ops-workflow-kit/actions/runs/28342669678",
    ],
    "skill-evidence.html": [
    ...
    "featured-drivedesk.html": [
        ...
        "The current AI Ops proof is green on commit <code>3df74d9</code> with CI run <code>28342669678</code>, including the business scenario replay, first slice playbook, and reviewer observability snapshot.",
...
CURRENT_EVIDENCE_SNIPPETS = {
    "VERIFICATION_PACK.md": [
        ...
        "AI Ops First Slice Playbook is published",
        "https://github.com/AlexGerlitz/ai-ops-workflow-kit/blob/main/docs/FIRST_SLICE_PLAYBOOK.md",
        "AI Ops latest checked CI run succeeded on `3df74d9`",
        "https://github.com/AlexGerlitz/ai-ops-workflow-kit/actions/runs/28342669678",
