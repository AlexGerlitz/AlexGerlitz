...
REQUIRED_TEXT = {
    "README.md": [
        ...
        "shortlist signal, risk reduction, AI execution proof, recruiter Boolean search strings, and message triggers",
