...
REQUIRED_TEXT = {
    ...
    "linkedin-proof-signal.html": [
        ...
        "The live Skills surface is verified: All view starts with Telegram, REST APIs, OpenAPI Specification (OAS), GitHub, Python, Vector Databases, ERP, CRM, Systems Integration, and DevOps",
    ...
    "LINKEDIN_PROOF_SIGNAL.md": [
        ...
        "The live Skills surface is verified instead of assumed: All view starts with Telegram, REST APIs, OpenAPI Specification (OAS), GitHub, Python, Vector Databases, ERP, CRM, Systems Integration, and DevOps",
        "Verified LinkedIn Skill Surface",
        "Telegram (Software)",
...
CURRENT_EVIDENCE_SNIPPETS = {
    "VERIFICATION_PACK.md": [
        ...
        "All view: Telegram, REST APIs, OpenAPI Specification (OAS), GitHub, Python, Vector Databases, ERP, CRM, Systems Integration, DevOps.",
    ...
    "verification-pack.html": [
        ...
        "profile shows AutoSchool54 / Автошкола 54 remote infrastructure support since March 2024.",
        "LinkedIn Proof Signal first, then DriveDesk AI Operator - Proof Route, Fixed-Scope AI Automation Offers, and DriveDesk Core",
        "Skills surface: All view shows Telegram, REST APIs, OpenAPI Specification (OAS), GitHub, Python, Vector Databases, ERP, CRM, Systems Integration, and DevOps; Tools & Technologies shows Python, REST APIs, GitHub, Telegram, pytest, OpenAPI, SaaS, Docker, FastAPI, and PostgreSQL.",
