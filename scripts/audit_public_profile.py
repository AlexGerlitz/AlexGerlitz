...
REQUIRED_TEXT = {
    ...
    "linkedin-recruiter-packet.html": [
        ...
        "International backend/platform role with AI workflow or integration ownership",
    ...
    "resume-pdf.html": [
        ...
        "Backend/Python/Internal Tools -> backend-first-screen.html -> autoschool-intake-admin.html",
        "Search-match stack: Python, FastAPI, PostgreSQL, Docker, Docker Compose, RAG, n8n, Telegram",
    ...
    "llms.txt": [
        ...
        "Role Fit Pack",
        "role-fit summary for AI automation, backend/platform, Autoschool intake/admin first-job proof, integration, DevOps, Europe-compatible remote signal, shortlist proof, structured role-fit decision path, and Decision-Ready Contact before PDF resume.",
...
CURRENT_EVIDENCE_SNIPPETS = {
    "VERIFICATION_PACK.md": [
        ...
        "FastAPI, GitHub Actions, RAG, Python, PostgreSQL, Docker, CRM/ERP/API integration, OpenAPI, Systems Integration, and DevOps.",
