...
REQUIRED_TEXT = {
    ...
    "START_HERE.md": [
        ...
        "Enterprise Readiness",
        "international remote-team review of architecture, state, integration contracts, English-first docs, reliability, privacy, CI, runbooks, and handoff quality",
        "Role Fit Pack",
        "PDF Resume",
    ...
    "LINKEDIN_RECRUITER_PACKET.md": [
        ...
        "https://alexgerlitz.github.io/AlexGerlitz/linkedin-recruiter-packet.html",
        "30-Second Fit",
        "Target roles: Back End Developer, Python Developer, AI Automation Engineer",
        "Search Alignment",
        "Job title filters",
        "Skill filters",
    ...
    "enterprise-readiness.html": [
        ...
        "./ai-backend-proof-pack.html",
        "AI backend proof pack",
        "international remote team can inspect",
    ...
    "llms.txt": [
        ...
        "Enterprise Readiness",
        "international remote-team review route for architecture, state ownership, integration contracts, English-first docs, async proof paths, reliability, privacy, observability, CI, runbooks, and handoff quality",
        ...
        "Recruiter shortcut: for a remote role, start with LinkedIn Recruiter Packet, Hiring decision route, Remote role targets, Skill evidence, and the PDF resume.",
        "Best match: backend/platform, AI automation, CRM/ERP/API integration, internal tools, or DevOps ownership.",
        "AI Ops Workflow Kit",
