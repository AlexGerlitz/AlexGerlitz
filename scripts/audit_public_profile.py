...
REQUIRED_TEXT = {
    ...
    "hiring-decision.html": [
        ...
        "Open first: AI Automation Role Fit -> DriveDesk Proof Route -> AI Ops Hiring Signal Brief -> AI Ops Business Scenario Replay -> AI Backend Proof Pack -> Enterprise Readiness -> PDF Resume.",
    ...
    "llms.txt": [
        ...
        "one-minute role fit, high-bar specialist screen, why to shortlist me, specialist reason to message, risk reduction, strongest proof, first-month ownership, contact route",
