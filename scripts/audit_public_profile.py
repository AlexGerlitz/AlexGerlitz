...
REQUIRED_TEXT = {
    ...
    "llms.txt": [
        ...
        "Recruiter shortcut: for a remote role, start with LinkedIn Recruiter Packet, Recruiter Preferences, Hiring decision route, Remote role targets, Skill evidence, recruiter Boolean search strings, and the PDF resume.",
        "Best match: backend/platform, AI automation, CRM/ERP/API integration, internal tools, or DevOps ownership.",
