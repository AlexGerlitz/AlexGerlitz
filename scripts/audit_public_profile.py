...
REQUIRED_TEXT = {
    ...
    "START_HERE.md": [
        ...
        "https://alexgerlitz.github.io/AlexGerlitz/decision-ready-contact.html",
        "copy-ready first messages",
        "Role-market fit, parser-readable application lanes, exact stack keywords, AI workflow, backend/platform, integration, Docker/CI boundary, runbooks, contact context, and resume proof.",
    ...
    "enterprise-readiness.html": [
        ...
        "International backend/platform role with AI workflow, internal tools, or integration ownership",
        "Europe-compatible async product or operations team",
