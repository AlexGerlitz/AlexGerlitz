...
REQUIRED_TEXT = {
    ...
    "role-targets.html": [
        ...
        "Skill filters",
        "First proof route",
        '"First proof route", "description": "Autoschool Intake/Admin Proof, AI Backend Proof Pack, Role Fit, Skill Evidence, Decision-Ready Contact, and PDF Resume."',
        "Decision-Ready Contact",
        "Autoschool Intake/Admin Proof",
    ...
    "ROLE_TARGETS.md": [
        ...
        "Skill filters",
        "First message trigger",
        "Autoschool Intake/Admin Proof](https://alexgerlitz.github.io/AlexGerlitz/autoschool-intake-admin.html) -> [AI Backend Proof Pack](https://alexgerlitz.github.io/AlexGerlitz/ai-backend-proof-pack.html) -> [Role Fit](https://alexgerlitz.github.io/AlexGerlitz/role-fit.html) -> [Skill Evidence](https://alexgerlitz.github.io/AlexGerlitz/skill-evidence.html) -> [Decision-Ready Contact](https://alexgerlitz.github.io/AlexGerlitz/decision-ready-contact.html) -> [PDF Resume",
    ...
    "llms.txt": [
        ...
        "Shortest inbound path: Message on LinkedIn -> Decision-Ready Contact -> LinkedIn Recruiter Packet -> Hiring Decision -> Autoschool Intake/Admin Proof -> DriveDesk Proof Route -> AI Backend Proof Pack -> PDF resume.",
