...
REQUIRED_TEXT = {
    ...
    "featured-drivedesk.html": [
        ...
        "The current AI Ops proof is green on commit <code>184b46d</code> with CI run <code>28323928151</code>, including the reviewer observability snapshot.",
...
CURRENT_EVIDENCE_SNIPPETS = {
    "VERIFICATION_PACK.md": [
        ...
        "AI Ops latest checked CI run succeeded on `184b46d`",
        "https://github.com/AlexGerlitz/ai-ops-workflow-kit/actions/runs/28323928151",
