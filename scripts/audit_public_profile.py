...
REQUIRED_TEXT = {
    ...
    "index.html": [
        ...
        "right next route: remote role, fixed-scope project, technical review, or no-fit",
        "Shortest inbound path",
        "Delivery Capability -> Application Fit Pack -> Hiring Decision",
        "First useful result",
        "AI-native delivery loop",
        ...
        "before Delivery Capability, Application Fit Pack, Hiring Decision",
    ...
    "llms.txt": [
        ...
        "Employer Decision Path",
        "2-minute fit check: Delivery Capability -> Application Fit Pack -> Enterprise Readiness -> Role Fit Pack -> Decision-Ready Contact -> PDF resume.",
        ...
        "Shortest inbound path: Message on LinkedIn -> Decision-Ready Contact -> LinkedIn Recruiter Packet -> Delivery Capability -> Application Fit Pack -> Hiring Decision -> First Backend Role Screen -> Autoschool Intake/Admin Proof -> DriveDesk Proof Route -> AI Backend Proof Pack -> PDF resume.",
        ...
        "Recruiter shortcut: for a remote role, message first through Decision-Ready Contact with role title, remote setup, stack, first-month ownership, timeline, and compensation band if shareable, then use LinkedIn Recruiter Packet, Delivery Capability, Application Fit Pack, Hiring decision route, Recruiter Preferences, Remote role targets, Skill evidence, recruiter Boolean search strings, and the PDF resume.",
