...
REQUIRED_TEXT = {
    ...
    "llms.txt": [
        ...
        "LinkedIn Services Fit",
        "structured broad-category, best-fit request, and not-fit service filter data",
        "https://alexgerlitz.github.io/AlexGerlitz/linkedin-service-page-fit.html",
...
SITEMAP_LASTMOD_REQUIREMENTS = {
    ...
    "https://alexgerlitz.github.io/AlexGerlitz/LINKEDIN_SERVICE_PAGE_FIT.md": "2026-06-28",
