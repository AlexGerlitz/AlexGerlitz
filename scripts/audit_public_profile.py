...
REQUIRED_TEXT = {
    ...
    "llms.txt": [
        ...
        "Decision-Ready Contact",
        "minimum first context, fit read, risk check, smallest responsible first slice, proof-backed offer route, next step, structured contact-route data, and best first proof links.",
        "Start conversation",
        "recruiter shortcut, message triggers, role-target links, PDF resume, proof-backed project offer route, ownership-first context, and the fastest contact path",
        "Contact routes",
