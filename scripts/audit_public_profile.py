...
REQUIRED_TEXT = {
    ...
    "START_HERE.md": [
        ...
        "current workflow, systems involved, one observable success condition, constraints, and what must not break",
        "Inbound Brief",
        "LinkedIn Recruiter Packet",
        "https://alexgerlitz.github.io/AlexGerlitz/linkedin-recruiter-packet.html",
        "Recruiter Preferences",
    ...
    "llms.txt": [
        ...
        "Contact routes",
        "search intent first links for AI Automation/RAG, Backend/Python/Platform, CRM/ERP/API Integration, DevOps/Reliability, plus decision-ready context and response shape.",
        "Selected proof projects",
