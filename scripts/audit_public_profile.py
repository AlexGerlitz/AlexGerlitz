...
REQUIRED_TEXT = {
    ...
    "linkedin-recruiter-packet.html": [
        ...
        '"dateModified": "2026-06-30"',
        "Inbound Offer Fit",
        "Use this block when deciding whether to message, shortlist, or forward internally.",
        "The strongest inbound offers are concrete enough to route into proof without a generic intro call.",
        "Remote backend/platform role with AI workflow, internal tools, CRM/ERP/API integration, or DevOps ownership.",
        ...
        '"position": 1, "name": "First Backend Role Screen"',
        ...
        "Junior Backend Developer, Junior Python Developer, AI Automation Engineer",
        "Skill Filters",
        "Work Mode",
        "Remote / Location Filter",
        "Language / Review Filter",
    ...
    "recruiter-preferences.html": [
        ...
        "Featured route",
        "LinkedIn Proof Signal first, then First Backend Role Screen, Backend First Screen, Autoschool Intake/Admin Proof, DriveDesk Proof Route, Fixed-Scope AI Automation Offers, and DriveDesk Core; AI Backend Proof Pack, Enterprise Readiness, LinkedIn Recruiter Packet, Decision-Ready Contact, and PDF Resume are routed from GitHub/Pages.",
    ...
    "LINKEDIN_RECRUITER_PACKET.md": [
        ...
        "Search expansion titles: Junior Backend Developer, Junior Python Developer, AI Automation Engineer, Integration Engineer, LLM Workflow / RAG Engineer",
        "Fastest message route",
        "send one remote role or one workflow, success condition, systems, ownership boundary, and timeline",
        "First proof: [Decision-Ready Contact](https://alexgerlitz.github.io/AlexGerlitz/decision-ready-contact.html) -> [First Backend Role Screen](https://alexgerlitz.github.io/AlexGerlitz/first-backend-role.html) -> [Backend First Screen](https://alexgerlitz.github.io/AlexGerlitz/backend-first-screen.html) -> [Autoschool Intake/Admin Proof]",
