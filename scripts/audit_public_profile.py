...
REQUIRED_TEXT = {
    "README.md": [
        ...
        "LinkedIn Activation Pack with copy-ready post variants, first-comment copy, short-DM reply copy, and the visible skill order recruiters should see first",
    ...
    "index.html": [
        ...
        "Includes the LinkedIn Activation Pack, visible skill order, post variants, first-comment copy, and short-DM reply copy.",
        "./linkedin-recruiter-packet.html",
        "LinkedIn recruiter packet",
    ...
    "linkedin-proof-signal.html": [
        ...
        "The visible profile signal now starts with Python, REST APIs, OpenAPI, GitHub, DevOps, Platform Architecture, and Systems Integration.",
