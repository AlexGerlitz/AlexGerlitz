...
REQUIRED_TEXT = {
    ...
    "recruiter-preferences.html": [
        ...
        "Featured route",
        "LinkedIn Proof Signal first, then DriveDesk Proof Route, Fixed-Scope AI Automation Offers, and DriveDesk Core; AI Backend Proof Pack, Enterprise Readiness, LinkedIn Recruiter Packet, Decision-Ready Contact, and PDF Resume are routed from GitHub/Pages.",
    ...
    "LINKEDIN_RECRUITER_PACKET.md": [
        ...
        "First proof: [Decision-Ready Contact](https://alexgerlitz.github.io/AlexGerlitz/decision-ready-contact.html) -> [AI Backend Proof Pack]",
        "Search Alignment",
        "Recruiter Filter Map",
        "Remote / location",
        "Language / review",
    ...
    "llms.txt": [
        ...
        "Shortest inbound path: Message on LinkedIn -> Decision-Ready Contact -> LinkedIn Recruiter Packet -> Hiring Decision -> DriveDesk Proof Route -> AI Backend Proof Pack -> PDF resume.",
    ...
    "linkedin-proof-signal.html": [
        ...
        "The live Featured route now starts with LinkedIn Proof Signal.",
