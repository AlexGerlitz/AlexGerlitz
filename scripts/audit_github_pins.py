...
EXPECTED_PINS: tuple[ExpectedPin, ...] = (
    ...
    ExpectedPin(
        ...
        ("Platform/DevOps recovery evidence", "Docker deployment control panel", "CI/CD", "runbooks"),
        "JavaScript",
        ...
        (
            ...
            "https://alexgerlitz.github.io/AlexGerlitz/enterprise-readiness.html",
            "https://alexgerlitz.github.io/AlexGerlitz/intake-brief.html",
            "public DevOps/platform engineering evidence surface",
    ...
    ExpectedPin(
        ...
        (
            "I build **DriveDesk** and public work samples around Python/backend automation",
            "Fast Public Review",
            "Decision Snapshot",
    ...
    ExpectedPin(
        ...
        (
            "validation-boundary and desktop-automation evidence project",
            "Profile / contact route",
            "LinkedIn Recruiter Packet",
            "Decision-Ready Contact",
            "Shortest review path",
